...
class Garden(models.Model):
    ...
    garden = models.CharField(max_length=100, verbose_name='باغ')
    ...
    rent_price = models.IntegerField(verbose_name='اجاره', null=True, blank=True)
    ...
    def get_absolute_url(self):
        return reverse('garden_detail', args=[self.id])